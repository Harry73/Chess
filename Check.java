...
public class Check
{
	...
	private static Point findKing(TestBoard board, String color)
	{
		for (int i = 0; i <= 7; i++)
		{
			for (int j = 0; j <= 7; j++)
	...
	public static boolean checkWhite(TestBoard board)
	{
	...
	public static boolean checkBlack(TestBoard board)
	{
	...
	public static boolean checkWhite(TestBoard board, Point a, Point b)
	{
	...
	public static boolean checkBlack(TestBoard board, Point a, Point b)
	{
		Piece[][] testBoard = testMove(board, a, b);
	...
	public static Piece[][] testMove(TestBoard board, Point a, Point b)
	{
